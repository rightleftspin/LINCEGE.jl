...
direction number
"""
struct DirectionMatrix{W<:AbstractVector,M<:AbstractMatrix{<:Integer}} <:
       AbstractAdjacencyMatrix
        weight_info::W
        adj_matrix::M
end

function DirectionMatrix(real_space_lattice::RealSpaceLattice, tiling::Tiling)
        ...
        DirectionMatrix(directions, adj_matrix)
end
